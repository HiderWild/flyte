...
class SelectClusterRequest(_message.Message):
    __slots__ = ["org_id", "project_id", "task_id", "action_id", "action_attempt_id", "app_id", "domain_id", "operation"]
